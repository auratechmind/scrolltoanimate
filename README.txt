Easy Steps to use scroll to animate:

* ADD animate.css in Header
* ADD scroll-animate.js in Footer
...
Ex:	<div class="animated" animate="bounce" duration="2s" delay="1.2s"></div>
